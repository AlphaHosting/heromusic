...
client.user.setGame(`Hero Host  |.help`,"https://www.hero-host.com")
  console.log('')
  console.log('')
  console.log('+[-----------------------------------------------------------------]+')
...
const developers = ["436196132385980416","348555232529219585","400771470378270741"]
const adminprefix = ".";
client.on('message', message => {
